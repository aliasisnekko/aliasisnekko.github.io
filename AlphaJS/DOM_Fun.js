...
function changeAll() {
    ...
    document.querySelectorAll("p")[0, 1].classList.add("text-light");
    document.querySelector("h1").classList.add("text-dark");
    document.querySelectorAll("#sorry").innerHTML = "Things are now annoyingly grey, sorry!";
    document.querySelectorAll("#white").classList.add("btn-light");
}
